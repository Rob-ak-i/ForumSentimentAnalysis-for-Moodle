	...
	*/
	...
	public static class InnerTable{
		public static class Item{
			public static String windowName = "ForumBrowser";
			...
			public static String selectorModeMenuName = "Elements";
			public static String selectorModeMenuSwitchedName = "Nodes";
			public static String selectorModeMenuSwitched2Name = "Parts";
		...
		public static class Action{
			...
			public static String loadCircuitActionName = "LoadECircuit";
			public static String saveCircuitActionName = "SaveECircuit";
			public static String saveAsCircuitActionName = "SaveECircuitAs";
			public static String saveCircuitActionErroredName = "SaveECircuitError";
			...
			public static String computationsMenuAction3Name = "PrintForumDataTable";
		...
		public static class Console{
			public static String partsPartNode_SetCaption = "couldn't setup connection count to node manually, this variable just simplificates code.";
			public static String partsPartNode_getPartsForNode = "node hase already partList";
