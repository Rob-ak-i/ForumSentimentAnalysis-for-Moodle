	...
	*/
	...
	public static class InnerTable{
		...
		public static class Action{
			...
			public static String printSequenceMenuActionName = "print nWords Sequence tree on editor";
			public static String analyzeMessagesMenuActionName = "analyze MessagesBank from DataTable";
			public static String analyzeLemmaPatternsMenuActionName = "analyze all nWords from MessageBank(MessageBank)";
