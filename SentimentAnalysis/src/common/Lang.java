	...
	*/
	...
	public static class InnerTable{
		...
		public static class Action{
			...
			public static String computationsMenuAction3Name = "LanguageProcessing";
		...
		public static class GUI{
			public static String TableSelectorLable1 = "Select identifier name for saving table report";
			public static String TableSelectorLable2 = "Select identifier name for saving table";
			public static String TableSelectorLable3 = "Press unique identifier name for table"; 
			public static String TableSelectorLable4 = "Select identifier name for table which contains All Messages for language processing";
