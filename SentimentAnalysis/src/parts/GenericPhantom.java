...
public class GenericPhantom {
	...
	public static void performAction() {
		...
		switch(phantomType) {
		case phantomType_FORUM:
			CommonData.taskManager.addOperation(CommonData.scheme,"printDiscuss",AdditionalDataObjects.pack("cx", mathCoords.x).pack("cy", mathCoords.y).pack("discuss", CommonData.dataManager.getManagedElement(selectedElementIndex)).pack("isAppendMode", EntityEditorMouseListener.isLShiftPressed));
			...
			break;
		case phantomType_SEQUENCE:
			CommonData.taskManager.addOperation(CommonData.scheme,"printSequenceTree",AdditionalDataObjects.pack("cx", mathCoords.x).pack("cy", mathCoords.y).pack("rootSequence", CommonData.sequenceManager.getManagedElement(selectedElementIndex)));
			...
			break;
		case phantomType_TESTSYNTAX:
			CommonData.taskManager.addOperation(CommonData.scheme,"printMessagesSyntaxes",AdditionalDataObjects.pack("cx", mathCoords.x).pack("cy", mathCoords.y).pack("messages", CommonData.textManager.getManagedElement(selectedElementIndex)));
