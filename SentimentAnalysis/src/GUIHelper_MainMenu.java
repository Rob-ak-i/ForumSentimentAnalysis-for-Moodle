...
public class GUIHelper_MainMenu {
	...
	public static void addActionsToMenuBar(JMenuBar menuBar) {
		...
		Action printForumMenuAction = new  AbstractAction(common.Lang.InnerTable.Action.printForumMenuActionName) {
			public void actionPerformed(ActionEvent event) {
				EntityEditorMouseListener.mode=EntityEditorMouseListener.MODE_PUT_PHANTOM_MODE;
				GenericPhantom.phantomType=GenericPhantom.phantomType_FORUM;
				GenericPhantom.name=CommonData.discuss.title;
				GenericPhantom.caption="Forum Name = "+CommonData.discuss.name+";Forum Messages Count = "+Integer.toString(CommonData.discuss.messageList.size());
			}
		};
