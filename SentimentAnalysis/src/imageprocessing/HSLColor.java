...
/**
 * Р. Бакиев: да, я это позаимствовал у наших запаадных партнёров, чтобы меньше напрягаться с матчастью по прееобразованию HSL-RGB, нужному для построения гистограммы
	Posted by Rob Camick on July 5, 2009 https://tips4java.wordpress.com/2009/07/05/hsl-color/
